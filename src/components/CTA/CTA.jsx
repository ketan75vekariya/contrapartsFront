      ...
      <section data-aos="fade-up" className="container py-8 md:py-12">
        <div className="grid grid-cols-1 items-center gap-4 sm:text-ellipsis md:grid-cols-3 md:gap-8">
          <div className=" order-2 flex flex-col items-center gap-4 text-center text-lightGray md:col-span-2  md:items-start md:text-left ">
            ...
            <p className="">
              We are driven by a shared vision of becoming the preferred choice
              for brass manufacturing solutions. Join us on our journey as we
              strive to redefine industry standards, challenge the status quo,
              and deliver excellence in everything we do. Together, let&apos;s
              build a brighter future with Contraparts.
            </p>
